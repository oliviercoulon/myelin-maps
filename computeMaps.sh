...
PYTHON_PERSO=/hpc/meca/users/coulon.o/localPythonDev
...
do
    echo ${sub}
    echo '    Non-normalised version'
    /hpc/soft/brainvisa/brainvisa_4.6.0/bin/python ${PYTHON_PERSO}/myelin-maps/projectT1T2onSurface.py no_norm/${sub}_t1divt2_cropped_nobias_zp.nii.gz Surfaces/${sub}_Lwhite_fine.gii no_norm/${sub}_myelin.gii
    ...
    echo '    Normalised version'
    /hpc/soft/brainvisa/brainvisa_4.6.0/bin/python ${PYTHON_PERSO}/myelin-maps/projectT1T2onSurface.py norm/${sub}_t1divt2_cropped_nobias_norm_zp.nii.gz Surfaces/${sub}_Lwhite_fine.gii norm/${sub}_myelin.gii
